...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--gpu', type=str, default='0,1,2,3,4,5,6,7', help='GPUs')
        ...
        parser.add_argument('--resize_img', action='store_true',default=False)
        parser.add_argument('--baseline', type=str, default ='Uformer')
        

        # args for saving 
        parser.add_argument('--save_dir', type=str, default ='./baseline/state_dict/Uformer/',  help='save dir')
        ...
        #datatloader 
        ### dataset setting
        parser.add_argument('--dataset', type=str, default='BDD100K',help='Which dataset to train and test')
